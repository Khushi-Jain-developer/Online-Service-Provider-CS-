...
%>
                <a href="Controller/sp_confirm_booking_controller.jsp?assign_id=<%=s2.getAssign_id()%>">Confirm Booking</a>
                <br><a href="Controller/sp_confirm_booking_controller.jsp?assign_id=<%=s2.getAssign_id()%>">Re-Schedule Booking</a>
                <br><a href="Controller/sp_confirm_booking_controller.jsp?assign_id=<%=s2.getAssign_id()%>">Cancel Booking</a>
                <%
                } else {
