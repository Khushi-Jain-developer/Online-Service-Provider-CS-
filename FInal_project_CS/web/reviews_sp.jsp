...
<html>
    ...
    <body style ="background-image: url(img/portfolio/1.jpg); background-repeat: no-repeat; background-size: cover">
        ...
        <div style ="margin-top:160px"> <center>
                <h1 align ="center" style="color:black;text-decoration-line: underline;margin-top: 70px;font-size: 50px">View Reviews</h1>


                <table align ="center" border="1" style="margin-top:40px;background-image: url(img/background/light4.jpg); background-repeat: no-repeat; background-size: cover">
                    <tr style="font-weight: bold;text-align: center;height: 50px;font-size: 35px">
                        <th  style="widtht:10px;">Feedback-Id</th>
                        <th style="widtht:20px;">Customer</th>
                        <th style="widtht:20px;">Service</th>
                        <th style="widtht:30px;">Feedback</th>
                        <th style="widtht:20px;">Date</th>
                    </tr>
