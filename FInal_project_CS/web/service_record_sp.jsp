...
<html>
    ...
    <body style ="background-image: url(img/blog/building.jpg); background-repeat: no-repeat; background-size: cover">
        ...
        <div id ="category">
            ...
            <div id = "menu-bar">
                <ul>
                    <li class="active"><a href="accepted_bookings_sp.jsp"><i class="fa fa-clone"></i>Accepted Bookings</a></li>
                    <li ><a href="Rejected_bookungs_SP.jsp"><i class="fa fa-user">Cancel Bookings</i></a></li>
                    <li class="active"><a href="re_scheduleBookings_SP.jsp"><i class="fa fa-clone"></i>Re-Scheduled Bookings</a>
                </ul>
            </div>
        </div>
    </body>
